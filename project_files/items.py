...
class GameItem:
    ...
    def all_items() -> dict[ItemType, GameItemInterface]:
        return{
            ...
            ItemType.sapphire_bracelet:GameItem('sapphire bracelet', ItemType.sapphire_bracelet, "It's cold to the touch, and appears to pulse faintly. It has and inexplicable air to it, and seems almost to call to you, although you're unsure. You take note of the fine craftsmanship and the beautiful glow of the sapphire in the dim light, and you wonder who it could have belonged to, or where it could have come from.", True, GameFlag.found_bracelet),
