...
class NPC():
    ...
    def all_npcs() -> dict[NPCType, NPCInterface]:
        return {
            ...
            NPCType.marla: NPC("Marla", NPCType.marla, "She's young, no older than 17 by the looks of it, with thin sharp eyes, and unevenly cut jet black hair. She's wrapped in an oversized coat with baggy pants, and a scarf wrapped around her neck. Her appearance seems a bit odd, although looking around you notice that many people here do.", True)
        }
